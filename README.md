...
•	getBasket - возвращает объект всего содержимого корзины
...
•	get price - геттер возвращает цену товара в формате
...
•	setButtonClass – активация выбранной кнопки способа оплаты  
...
•	set total () - метод для указания списанной суммы 
